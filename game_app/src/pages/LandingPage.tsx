    ...
    <div className="min-h-screen p-12" style={{ background: 'linear-gradient(180deg,#020204 0%, #081018 70%)' }}>
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div className="space-y-6">
          ...
          <p className="text-gray-400 text-lg">An interactive game that teaches prompt engineering using a card-crafting metaphor. Drag prompt components to the bench, craft a prompt, and get instant educational feedback.</p>
        ...
        <div>
          <div className="neon-card p-6 rounded-2xl neon-glow">
            ...
            <ol className="mt-3 text-sm text-gray-300 space-y-2">
              <li>1. Add cards from the Components shelf to the Bench.</li>
